						...
						<div class="table-responsive data">
							<table class="table" id="tableData">
								...
								<tbody>
									...
									<tr>
										<td class="text-left"><?php if($cot['pago_recibo']){ ?><button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#recibo" data-recibo="<?= esc($cot['pago_recibo']) ?>"><i class="fa-solid fa-receipt"></i></button><?php } ?></td>
										...
										<?php if(check_permisos('admin') || check_permisos('super')){ ?>
										<td><a href="/cotizaciones/borrar/<?= esc($cot['id']) ?>/<?php echo $date ?>" class="btn btn-sm btn-secondary" onclick="return confirm('¿Estás seguro de Borrar el pedido?')"><i class="fa-solid fa-trash-can"></i></a></td>
										<?php } ?>
									</tr>
									<?php endforeach ?>
								</tbody>
